  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-space-gradient">
        <SEO
        title={"Alert History — Environmental Anomaly Email Logs"}
        description={"View the complete history of environmental anomaly alerts and notifications dispatched by Terra Guardians, founded by Pal Ghevariya."}
        path={"/alert-history"}
        image={"/og-alert-history.jpg"}
        keywords={"alert history, email logs, anomaly notifications, Pal Ghevariya, Terra Guardians, TerraPulse"}
      />
      <Navigation />
