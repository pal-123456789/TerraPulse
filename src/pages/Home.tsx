...
const Home = () => {
  const mount3D = useDeferredMount(400);
  const features = [
  ...
  return (
    <div className="min-h-screen bg-space-gradient relative overflow-x-hidden">
      ...
      <SEO
        title={"Terra Guardians | TerraPulse — AI Environmental Monitoring"}
        description={"AI-powered real-time environmental monitoring, anomaly detection and climate predictions using NASA satellite data. Founded by Pal Ghevariya."}
        path={"/"}
        keywords={"AI environmental monitoring, anomaly detection, NASA satellite data, climate tracking, Pal Ghevariya, Terra Guardians, TerraPulse"}
        schema={{
          "@context": "https://schema.org",
          "@type": "WebPage",
          name: "Terra Guardians — Home",
          url: "https://www.terraguardians.us/",
          isPartOf: { "@id": "https://www.terraguardians.us/#website" },
          about: "AI-powered real-time environmental anomaly detection and climate monitoring",
          primaryImageOfPage: "https://www.terraguardians.us/og-image.jpg",
        }}
      />
      <Navigation />
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 pt-24 md:pt-32 pb-12 md:pb-20 relative z-10">
        ...
        <div className="max-w-6xl mx-auto text-center mb-20 md:mb-32">
          {/* 3D Globe — opacity-only fade so r3f mounts immediately at full size */}
          <motion.div
