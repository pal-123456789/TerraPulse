...
const Privacy = () => {
  return (
    <div className="min-h-screen bg-space-gradient">
      <SEO
        title={"Privacy Policy — Terra Guardians"}
        description={"Privacy Policy for Terra Guardians (TerraPulse) by Pal Ghevariya. How we collect, use and protect your environmental and personal data."}
        path={"/privacy"}
        image={"/og-privacy.jpg"}
        keywords={"privacy policy, data protection, Pal Ghevariya, Terra Guardians, TerraPulse"}
      />
      <Navigation />
