...
import { Loader2, User, Home, Award, Activity, BookOpen, Bell, Calendar, MapPin, Mail, Shield, TrendingUp, Clock, FileText, AlertTriangle, Eye, Globe, Settings, LogOut } from "lucide-react";
                  ...
                  <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-5">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="avatar_url" value={profile.avatar_url} onChange={(e) => setProfile({ ...profile, avatar_url: e.target.value })} placeholder="Enter avatar image URL" className="bg-background/50 border-border focus:border-primary transition-colors" />
                      </div>
