...
const Terms = () => {
  return (
    <div className="min-h-screen bg-space-gradient">
      <SEO
        title={"Terms of Service — Terra Guardians"}
        description={"Terms of Service for Terra Guardians (TerraPulse), the AI environmental monitoring platform founded by Pal Ghevariya."}
        path={"/terms"}
        image={"/og-terms.jpg"}
        keywords={"terms of service, legal, Pal Ghevariya, Terra Guardians, TerraPulse"}
      />
      <Navigation />
