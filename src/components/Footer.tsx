...
const SocialLink = memo(({ href, icon: Icon, label }: { href: string; icon: React.ElementType; label: string }) => (
  <motion.a
    ...
    aria-label={label}
    title={label}
    className="w-11 h-11 rounded-lg bg-card/50 flex items-center justify-center text-muted-foreground transition-all duration-300 relative overflow-hidden group"
  ...
  >
    ...
    />
    <Icon className="w-5 h-5 relative z-10 group-hover:text-primary transition-colors" aria-hidden="true" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          >
            ...
            <div className="flex gap-3">
              <SocialLink href="https://github.com" icon={Github} label="TerraPulse on GitHub" />
              <SocialLink href="https://linkedin.com" icon={Linkedin} label="TerraPulse on LinkedIn" />
              <SocialLink href="https://twitter.com" icon={Twitter} label="TerraPulse on Twitter" />
            </div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div>
                <p className="text-sm font-medium text-foreground mb-1">Team TerraGuardians</p>
                <a
