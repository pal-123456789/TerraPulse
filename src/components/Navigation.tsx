import { Link, useLocation } from "react-router-dom";
 import { Globe, Compass, History, BarChart2, Info, BarChart3, GraduationCap, Menu, X, Map, Rocket, Orbit, Activity } from "lucide-react";
...
const Navigation = memo(() => {
  ...
  const navItems = [
    ...
    { to: "/solar-system", label: "Solar", icon: Orbit },
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <Button
              ...
              className="lg:hidden relative overflow-hidden min-h-11 min-w-11"
